...
export const mockApi: CraftelApi = {
  ...
  startCurrentPhase:async()=>{throw new Error("mock harness unavailable")},stopRun:async()=>{throw new Error("mock harness unavailable")},getSession:async()=>{throw new Error("not found")},listSessions:async()=>[],listRuns:async()=>[],getRun:async()=>{throw new Error("not found")},listRunEvents:async()=>[],
};
