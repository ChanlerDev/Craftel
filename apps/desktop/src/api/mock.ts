...
export const mockApi: CraftelApi = {
  ...
  startPhaseRun:async()=>{throw new Error("mock harness unavailable")},stopRun:async()=>{throw new Error("mock harness unavailable")},followUp:async()=>{throw new Error("mock harness unavailable")},getSession:async()=>{throw new Error("not found")},listSessions:async()=>[],listRuns:async()=>[],getRun:async()=>{throw new Error("not found")},listRunEvents:async()=>[],
};
